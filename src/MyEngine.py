...
def engine(filename, text_output):
    ...
    RHS_dc = [0] * rows
    RHS_ac = [0] * rows
    dc_res = MyStamp.dc_stamp(col_br_list, MNA_dc, RHS_dc, RHS_ac, v_list, i_list, d_list, mos_list,
                               element_list, l_list)
    ...
    for control_command in control_list:
        if control_command[0] == 'dc':
            ...
            dc_sweep_list = []
            dc_2srcs_res_list = []
            MyStamp.dc_sweep(control_command, MNA_dc, RHS_dc, v_list, i_list, dc_sweep_list, dc_2srcs_res_list,
        ...
        if control_command[0] == 'ac':
            ...
            # print "RHS_ac:", RHS_ac
            MyStamp.ac_analysis(control_command, rows, col_normal, c_list, l_list, MNA_dc,
        ...
        if control_command[0] == "tran":
            ...
            time_list = []
            MyStamp.tran_analysis(control_command, MNA_tran, tran_res_list, tran_print_list, c_list, l_list,
