...
def tran_analysis(control_command, MNA_tran, tran_res_list, tran_print_list,c_list, l_list, v_list, 
                 i_list, d_list, mos_list, time_list, rows, col_normal, tran_rows,text_output):
